...
<script type="text/javascript">
	...
	function searchDataDic(){
		$("#dg").datagrid('load',{
			...
			"dataDicValue":$("#s_dataDicValue").val()//意思就是带查询参数提交到后台然后再将查询的结果返回到页面上post请求在dg里面有
		});
	}
	...
	function saveDataDic(){
		var dataDicName=$("#dataDicName").combobox("getText");//getText是获取文本，因为这个下拉框的值可能是用户自己编辑的
	...
	function deleteDataDic(){
		...
		$.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗?",function(r){
			//r是boolean类型的，数据字典点了确认就是true，否则就是false
			if(r){
...
<table id="dg" title="数据字典管理" class="easyui-datagrid"
	...
	<thead>
		...
		<!-- 这个是前面的复选框 -->
			...
			<th field="dataDicName" width="300" align="center">数据字典名</th>
			<th field="dataDicValue" width="300" align="center">数据字典值</th>
		</tr>
	</thead>
</table>
<div id="tb">
